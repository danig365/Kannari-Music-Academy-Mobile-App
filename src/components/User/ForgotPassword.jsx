...
const ForgotPassword = () => {
  ...
  const requestReset = async () => {
    ...
    try {
      await axios.post(`${API_BASE}${ENDPOINTS.STUDENT_PASSWORD_RESET_REQ}`, formData)
  ...
  const submitNewPassword = async () => {
    ...
    try {
      const res = await axios.post(`${API_BASE}${ENDPOINTS.STUDENT_PASSWORD_RESET_CONF}`, formData)
      if (res.data.bool) {
